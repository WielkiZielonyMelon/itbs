...
@pytest.mark.parametrize("obj",
                         [CombatMech,
                          JetMech])
@pytest.mark.parametrize("attacker,         weapon,               vector, obj_pos, obj_after_pos",
                         [(Firefly(),       AcceleratingThorax(), (0, 1), (1, 3), (1, 3)),
                          (ArtilleryMech(), Artemis(),            (0, 2), (1, 3), (1, 3)),
                          (JetMech(),       AerialBombs(),        (0, 2), (1, 2), (1, 2)),
                          (Scarab(),        SpittingGlands(),     (0, 2), (1, 3), (1, 3)),
                          (Hornet(),        Stinger(),            (0, 1), (1, 2), (1, 2)),
                          (CannonMech(),    TaurusCannon(),       (0, 1), (1, 3), (1, 4)),
                          (CombatMech(),    TitanFist(),          (0, 1), (1, 2), (1, 3))])
def test_weapon_on_corpse_leaver_object(obj, attacker, weapon, vector, obj_pos, obj_after_pos):
    obj = obj()
    board = Board()
    ...
    assert board[obj_after_pos].get_object() is not None


@pytest.mark.parametrize("obj",
                         [SatelliteRocket,
                          ReadySatelliteRocket])
@pytest.mark.parametrize("attacker,         weapon,               vector, obj_pos, obj_after_pos",
                         [(Firefly(),       AcceleratingThorax(), (0, 1), (1, 3), (1, 3)),
                          (ArtilleryMech(), Artemis(),            (0, 2), (1, 3), (1, 3)),
                          (JetMech(),       AerialBombs(),        (0, 2), (1, 2), (1, 2)),
                          (Scarab(),        SpittingGlands(),     (0, 2), (1, 3), (1, 3)),
                          (Hornet(),        Stinger(),            (0, 1), (1, 2), (1, 2)),
                          (CannonMech(),    TaurusCannon(),       (0, 1), (1, 3), (1, 3)),
                          (CombatMech(),    TitanFist(),          (0, 1), (1, 2), (1, 2))])
def test_weapon_on_corpse_leaver_object(obj, attacker, weapon, vector, obj_pos, obj_after_pos):
    obj = obj()
    board = Board()
