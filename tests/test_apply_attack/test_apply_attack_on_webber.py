...
@pytest.mark.parametrize("attacker,         weapon,               attack_vector, webber_pos, webbed_pos",
                         [(Firefly(),       AcceleratingThorax(), (0, 1), (1, 3), (0, 3)),
                          (ArtilleryMech(), Artemis(),            (0, 2), (1, 3), (0, 3)),
                          (JetMech(),       AerialBombs(),        (0, 2), (1, 2), (0, 2)),
                          (Scarab(),        SpittingGlands(),     (0, 2), (1, 3), (0, 3)),
                          (Hornet(),        Stinger(),            (0, 1), (1, 2), (0, 2)),
                          (CannonMech(),    TaurusCannon(),       (0, 1), (1, 3), (0, 3)),
                          (CombatMech(),    TitanFist(),          (0, 1), (1, 2), (0, 2))])
def test_weapon_kills_webber(webbed_obj, attacker, weapon, attack_vector, webber_pos, webbed_pos):
    board = Board()
