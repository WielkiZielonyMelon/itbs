...
def test_artemis_on_shielded_vek():
    board = Board()
    ...
    mech0_attack = Attack(attacker=mech0.get_id(), weapon=Artemis(),
...
def test_artemis_on_shielded_mech():
    board = Board()
...
def test_artemis_on_shielded_building():
    board = Board()
