...
def test_aerial_bombs_shell_psion_on_mech():
    board = Board()
...
def test_aerial_bombs_on_shielded_vek():
    board = Board()
...
def test_aerial_bombs_on_shielded_mech():
    board = Board()
...
def test_aerial_bombs_on_shielded_building():
    board = Board()
