...
from src.game_objects.vek import Firefly, AlphaFirefly, Spiderling, BlastPsion, ShellPsion
from src.game_objects.weapons.accelerating_thorax import AcceleratingThorax, EnhancedThorax


def test_single_accelerating_thorax():
    board = Board()
    mech0 = CombatMech()
    mech0_pos = (0, 0)
...
def test_single_accelerating_thorax_on_edge():
    board = Board()
...
def test_single_accelerating_thorax_forest_tile():
    board = Board()
...
def test_single_accelerating_thorax_mech_on_forest_tile():
    board = Board()
...
def test_single_accelerating_thorax_mech_on_forest_tile_in_middle():
    board = Board()
...
def test_single_enhanced_thorax_mech_on_forest_tile_in_middle():
    board = Board()
...
def test_accelerating_thorax_attack_neighbour_exploding_vek():
    board = Board()
...
def test_accelerating_thorax_attack_neighbour_exploding_vek_chain_reaction():
    board = Board()
...
def test_accelerating_thorax_shell_psion():
    board = Board()
    ...
    vek1_attack_vector = (0, -1)
    vek1_attack = Attack(attacker=vek1.get_id(), weapon=AcceleratingThorax(),
                         vector=vek1_attack_vector)
    ...
    apply_attack(board, vek1_attack)
    assert vek0.get_health() == vek0.get_max_health()


def test_accelerating_thorax_shell_psion_on_mech():
    board = Board()
...
def test_accelerating_thorax_on_shielded_vek():
    board = Board()
...
def test_accelerating_thorax_on_shielded_mech():
    board = Board()
...
def test_accelerating_thorax_on_shielded_building():
    board = Board()
