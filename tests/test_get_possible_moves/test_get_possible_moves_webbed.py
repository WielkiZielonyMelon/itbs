...
from src.game_objects.vek import Firefly, Leaper
from src.helpers.get_possible_moves import get_possible_moves


@pytest.mark.parametrize("pos, webber_pos, mobility,expected_moves",
                         [((0, 0), (0, 1), 0, []),
                          ((0, 0), (1, 0), 1, [(0, 1), (1, 0)]),
                          ((0, 0), (1, 0), 2, [(0, 1), (1, 0), (1, 1), (2, 0), (0, 2)]),
                          ((7, 0), (6, 0), 2, [(7, 1), (6, 0), (6, 1), (5, 0), (7, 2)]),
                          ((7, 7), (7, 6), 2, [(7, 6), (6, 7), (6, 6), (5, 7), (7, 5)]),
                          ((0, 7), (0, 6), 2, [(0, 6), (1, 7), (1, 6), (2, 7), (0, 5)])])
def test_expected_moves(pos, webber_pos, mobility, expected_moves):
    board = Board()
    mech = CombatMech()
